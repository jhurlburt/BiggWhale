	...
	internal class DumperStep : IPipelineStep
	{
		...
		public void Process(Crawler crawler, PropertyBag propertyBag)
		{
			...
			lock (this)
			{
                ...
                string outputFolder = Properties.Settings.Default.DataFolder + DateTime.Now.ToString("yyyy-MM-dd") + "\\";
                try
                {
                ...
                if (propertyBag.Step.Uri.ToString().Contains("Classifications"))
                {
                    ...
                    try
                    {
                        string fileName = Properties.Settings.Default.DataFolder + DateTime.Now.ToString("yyyy-MM-dd") + "\\Classifications.txt";
                        using (StreamWriter writetext = new StreamWriter(fileName))
                        {
                            writetext.WriteLine(propertyBag.Text.Replace(Environment.NewLine, string.Empty));
                        }
