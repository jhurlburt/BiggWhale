...
namespace BiggWhaleDataCollector
{
	...
	internal class DumperStep : IPipelineStep
	{
		...
		public void Process(Crawler crawler, PropertyBag propertyBag)
		{
			...
			lock (this)
			{
                //MessageBox.Show(propertyBag.Step.Uri.ToString());--JH Commented line
