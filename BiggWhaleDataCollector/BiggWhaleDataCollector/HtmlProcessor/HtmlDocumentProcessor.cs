...
using BiggWhaleDataCollector.HtmlProcessor.Extensions;
using BiggWhaleDataCollector.HtmlProcessor.Properties;
using BiggWhaleDataCollector.Interfaces;
using BiggWhaleDataCollector.Utils;

namespace BiggWhaleDataCollector.HtmlProcessor
{
