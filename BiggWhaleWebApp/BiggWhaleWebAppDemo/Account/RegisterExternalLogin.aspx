<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="RegisterExternalLogin.aspx.cs" Inherits="BiggWhaleWebAppDemo.Account.RegisterExternalLogin" %>
